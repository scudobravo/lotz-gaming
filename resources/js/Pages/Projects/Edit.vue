...
const form = useForm({
  ...
  initial_scene_id: props.project.initial_scene_id || null,
  required_items: props.project.required_items.map(item => item.id)
});

const coverPreview = ref(props.project.cover_url);
          ...
          <div class="p-6">
            <form @submit.prevent="submit" class="space-y-8 divide-y divide-gray-200">
              <div class="space-y-8 divide-y divide-gray-200">
                <div>
                  <div>
                    <h3 class="text-lg leading-6 font-medium text-gray-900">Modifica Progetto</h3>
                    <p class="mt-1 text-sm text-gray-500">Modifica le informazioni del tuo progetto.</p>
                  </div>
                  ...
                  <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <p class="mt-1 text-sm text-gray-500">Seleziona le lettere o gli oggetti che i giocatori dovranno collezionare per completare il gioco.</p>
                    ...
                    <div v-if="project.qr_code" class="sm:col-span-6">
                      <label class="block text-sm font-medium text-gray-700">QR Code</label>
                      <div class="mt-2">
                        <img :src="project.qr_code" alt="QR Code" class="h-32 w-32" />
                      </div>
                    </div>
                  </div>
                </div>
